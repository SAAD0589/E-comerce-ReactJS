    ...
    return (
        <footer id='contact'
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4">
                    <div class="mb-6">
                        ...
                        <ul class="mb-0 list-none">
                            <li>
                                <a href="#!" class="text-white transition-colors duration-300 hover:text-slate-600">saadayouch08@gmail.com</a>
                            </li>
                            <li>
                                <a href="#!" class="text-white transition-colors duration-300 hover:text-slate-600">010-020-0340</a>
                            </li>
                    ...
                    <div class="mb-6">
                        <h5 class="mb-2.5 font-bold uppercase">Shopping & Categories</h5>

                        <ul class="mb-0 list-none">
                            <li>
                                <a href="#!" class="text-white transition-colors duration-300 hover:text-slate-600">Men’s Shopping</a>
                            </li>
                            <li>
                                <a href="#!" class="text-white transition-colors duration-300 hover:text-slate-600">Women’s Shopping</a>
                            </li>
                            <li>
                                <a href="#!" class="text-white transition-colors duration-300 hover:text-slate-600">Kid's Shopping</a>
                            </li>
                    ...
                    <div class="mb-6">
                        ...
                        <ul class="mb-0 list-none">
                            <li>
                                <a href="#!" class="text-white transition-colors duration-300 hover:text-slate-600">Homepage</a>
                            </li>
                            <li>
                                <a href="#!" class="text-white transition-colors duration-300 hover:text-slate-600">About Us</a>
                            </li>
                            <li>
                                <a href="#!" class="text-white transition-colors duration-300 hover:text-slate-600">Help</a>
                            </li>
                            <li>
                                <a href="#!" class="text-white transition-colors duration-300 hover:text-slate-600">Contact Us</a>
                            </li>
                        </ul>
                    </div>

                    <div class="mb-6">
                        <h5 class="mb-2.5 font-bold uppercase">Help & Information</h5>
                        ...
                        <ul class="mb-0 list-none">
                            ...
                            <li>
                                <a href="#!" class="text-white transition-colors duration-300 hover:text-slate-600">FAQ's</a>
                            </li>
                            <li>
                                <a href="#!" class="text-white transition-colors duration-300 hover:text-slate-600">Shipping</a>
                            </li>
                            <li>
                                <a href="#!" class="text-white transition-colors duration-300 hover:text-slate-500">Tracking ID</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div
                ...
                >Copyright © 2022 SlitonShoper Co., Ltd. All Rights Reserved.
                </a>
            </div>
        </footer>
    )
