        ...
        <div class="md:flex ">
			...
			{items.map(item=>{
				 const incrementAmount = () => {
					...
					// You may want to update the item.amount in the state or trigger a parent component update to reflect the change properly
				  };
				return(
            				...
            				<div class="flex justify-center items-center">
            					...
            					<div class="pr-8 flex ">
            						...
            						<input type="text"
									 ...
									 bg-gray-100 border h-6 w-8 
									 rounded text-sm px-2 mx-2" value={item.amount}/>
            					...
            					<div class="pr-8 ">
            						...
            						<span class="text-xs font-medium">$ {item.price}</span>
            					</div>
            					<div>
            			...
            			<div class="flex justify-between items-center mt-6 pt-6 border-t"> 
            				...
            				<div class="flex justify-center items-end">
								...
								{items.reduce((Total,p)=>{return Total+=p.price*p.amount},0)}
								</span>
            		...
            		<div class=" p-5 bg-gray-800 rounded overflow-visible">
            			...
            			<div class="flex justify-center flex-col pt-3">
							...
							class="focus:outline-none w-full
							 h-6 bg-gray-800 text-white placeholder-gray-300
							  text-sm border-b border-gray-600 py-4" 
            			...
            			<div class="flex justify-center flex-col pt-3">
            				...
            				<input type="text" 
							class="focus:outline-none 
							w-full h-6 bg-gray-800 text-white 
							placeholder-gray-300 text-sm border-b
            			...
            			<div class="grid grid-cols-3 gap-2 pt-2 mb-3">
            				...
            				<div class="col-span-2 ">
            					...
            					<div class="grid grid-cols-2 gap-2">
									...
									class="focus:outline-none
									 w-full h-6 bg-gray-800 text-white
									  placeholder-gray-300 text-sm border-b
									   border-gray-600 py-4" placeholder="mm"/>
            						<input type="text" 
									class="focus:outline-none
									 w-full h-6 bg-gray-800 text-white
									  placeholder-gray-300 text-sm border-b
									   border-gray-600 py-4" placeholder="yyyy"/>
            				...
            				<div class="">
            					...
            					<input type="text" 
								class="focus:outline-none w-full h-6 
								bg-gray-800 text-white placeholder-gray-300
								 text-sm border-b border-gray-600 py-4" placeholder="XXX"/>
