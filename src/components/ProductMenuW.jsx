...
import ProductMenuKids from './ProductMenuKids';
// import { useSelector } from 'react-redux';
import { Link } from 'react-router-dom';

const ProductMenuW = (props) => {
    // const items=useSelector(data=>data.Product)

    return (
        <div className="container  p-15 ">
            <div className='flex flex-col items-center justify-center'>
                <h1 className="self-start text-5xl p-8">Women's Latest</h1>
            ...
            <div className="flex flex-row items-center justify-center mx-8 ">
                ...
                >
                    {props.dataWomen.filter(product=>product.type==='woman')
                    
                  .map((product, index) => (
                        <div id='woman' key={index} style={{ width: "90%" }} className='p-5'>
            ...
            <ProductMenuKids dataWomen={props.dataWomen}/>

        </div>
    )
}

export default ProductMenuW
